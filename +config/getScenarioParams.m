...
%SCENARIOSCALE Individuelle Skalierungsfaktoren für die Szenarien
    ...
    scale(2) = base;
    scale(2).capacityEV_kWh   = 3.78;   %%%
    scale(2).pMaxEV_kW        = 3.78;   %%%
    scale(2).numEV            = 3.78;   %%%
    scale(2).capacityBatt_kWh = 3.55;   %%%
    scale(2).pMaxBatt_kW      = 1.89;   %%%
    scale(2).hpCount          = 1.21;   %%%
    scale(2).pvScaleMWp       = 2.25;   %%%
    scale(2).buildingWeights  = 1;   %%%

    % Szenario 2050: starke Steigerungen
    scale(3) = base;
    scale(3).capacityEV_kWh   = 13.74;   %%%
    scale(3).pMaxEV_kW        = 13.74;   %%%
    scale(3).numEV            = 13.74;   %%%
    scale(3).capacityBatt_kWh = 7.23;   %%%
    scale(3).pMaxBatt_kW      = 3.95;   %%%
    scale(3).hpCount          = 4.21;   %%%
